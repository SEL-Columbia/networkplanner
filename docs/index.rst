...
`NP <../..>`_ is a decision support tool for exploring electrification options in rural communities.  It has been used to compare the long-term costs of installing solar, diesel or grid distribution networks and perform sensitivity analyses on variables such as demand growth for electrification plans in Kenya, Senegal and Ghana.

`Click here to begin using the system <../..>`_.  You are encouraged to experiment by changing variables to fit the economic profile of your region.  More experienced users can upload custom datasets of unelectrified communities and the locations of existing high and medium voltage lines.
