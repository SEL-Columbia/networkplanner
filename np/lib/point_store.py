...
def save(shapePath, geoLocations, spatialReferenceProj4):
    ...
    spatialReference = getSpatialReferenceFromProj4(spatialReferenceProj4)
    # Create layer
...
def getSpatialReferenceFromProj4(spatialReferenceProj4):
    spatialReference = osgeo.osr.SpatialReference()
    spatialReference.ImportFromProj4(spatialReferenceProj4)
